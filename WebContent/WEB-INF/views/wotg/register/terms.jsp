<%@ include file="/WEB-INF/views/wotg/include/header/headerNoMenu.jsp"%>
...
<form:form commandName="registrationTerms" method="post">
  <fieldset>
    ...
    <!-- Display Plans -->
    <div class="registrationTerms"><%@ include file="/WEB-INF/views/wotg/terms/registration_tos.jsp"%></div>
...
<%@ include file="/WEB-INF/views/wotg/include/footer/footerNoMenu.jsp"%>