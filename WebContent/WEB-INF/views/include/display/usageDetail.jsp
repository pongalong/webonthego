...
<tr>
  <td>${usageDetail.dateAndTime.month}/${usageDetail.dateAndTime.day}/${usageDetail.dateAndTime.year} ${usageDetail.dateAndTime.hour}:<fmt:formatNumber
      value="${usageDetail.dateAndTime.minute}" pattern="00" /> <c:choose>
  ...
  <td><img class="info" src="<spring:url value='/static/images/buttons/i.png' />" /> <%@ include file="/WEB-INF/views/include/display/usageDetailEventBox.jsp"%>
  </td>
</tr>