...
<tr>
  ...
  <td>
    ${usageDetail.dateAndTime.month}/${usageDetail.dateAndTime.day}/${usageDetail.dateAndTime.year} ${usageDetail.dateAndTime.hour}:
    <fmt:formatNumber value="${usageDetail.dateAndTime.minute}" pattern="00" />
    <c:choose>
