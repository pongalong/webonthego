  ...
  <div class="container">
    <div id="main-content">
      <div class="span-18 colborder" style="min-height: 200px;">
        <h3 style="margin-bottom: 10px; padding-bottom: 0px; border-bottom: 1px #ccc dotted;">Ticket ${note.ticket.id}</h3>
        <p>
          <b>Title:</b> ${note.ticket.title}<br /> <b>Description:</b>${note.ticket.description}
        </p>

        <form:form id="updateTicketNote" cssClass="validatedForm" method="post" commandName="note">
          ...
          <div class="buttons">
            <a id="updateTicketNote_button_submit" href="#" class="button action-m"><span>Update</span></a> <input id="updateTicketNote_submit" type="submit"
