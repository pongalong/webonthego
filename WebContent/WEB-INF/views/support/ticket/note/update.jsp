    ...
    <div class="mainbody">
      <div class="span-18 colborder" style="min-height: 200px;">
        ...
        <form:form id="updateTicketNote" cssClass="validatedForm" method="post" commandName="ticketNote">
          ...
          <div class="buttons">
            <a href="<spring:url value="/support/ticket/view/ticket/${ticketNote.ticket.id}" />" class="mBtn"><span>Cancel</span></a> <input type="submit"
              name="_eventId_submit" value="Update" />
          </div>
