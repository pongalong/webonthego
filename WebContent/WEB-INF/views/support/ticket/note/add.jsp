    ...
    <div id="main-content">
      <div class="span-18 colborder" style="min-height: 200px;">
        ...
        <form:form id="createTicketNote" cssClass="validatedForm" method="post" commandName="ticketNote">
          ...
          <div class="buttons">
            <a id="createTicketNote_button_submit" href="#" class="button action-m"><span>Add</span></a> <a
              href="<spring:url value="/support/ticket/view/ticket/${ticket.id}" />" class="button action-m multi"><span>Cancel</span></a><input
              id="createTicketNote_submit" type="submit" name="_eventId_submit" value="Continue" class="hidden" />
          </div>
