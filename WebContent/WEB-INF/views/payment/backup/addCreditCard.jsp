    ...
    <div id="main-content">
      <div class="span-18 colborder" style="min-height: 200px;">
        ...
        <form:form id="addCreditCard" cssClass="validatedForm" method="post" commandName="creditCard">
          ...
          <p>You will be charged $10 which will be applied to the balance in your account. Every time your balance drops below $2, we will automatically add
            another $10 to your account, which will be charged to this credit card.</p>
