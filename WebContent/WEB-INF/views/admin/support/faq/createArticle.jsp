...
<form:form commandName="article" method="post" cssClass="form-horizontal">
  <fieldset>
    ...
    <div class="control-group">
      <form:label path="articleData.contents" cssClass="control-label required">Contents</form:label>
      <div class="controls">
        <form:input path="articleData.contents" cssClass="span5" cssErrorClass="span5 validationFailed" />
      </div>
    </div>

    <div class="control-group">
      <form:label path="articleData.contentsText" cssClass="control-label required">Contents Text</form:label>
      <div class="controls">
        <form:input path="articleData.contentsText" cssClass="span5" cssErrorClass="span5 validationFailed" />
      </div>
    </div>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <form:select path="categories[0].id" cssClass="span5" cssErrorClass="span5 validationFailed" cssStyle="width:312px;">
