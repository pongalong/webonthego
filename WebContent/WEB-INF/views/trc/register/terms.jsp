<%@ include file="/WEB-INF/views/trc/include/header/headerNoMenu.jsp"%>
...
<form:form commandName="registrationTerms" method="post">
  <fieldset>
    ...
    <!-- Display Plans -->
    <div class="registrationTerms"><%@ include file="/WEB-INF/views/trc/terms/registration_tos.jsp"%></div>
...
<%@ include file="/WEB-INF/views/trc/include/footer/footerNoMenu.jsp"%>