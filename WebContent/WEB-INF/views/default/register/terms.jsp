<%@ include file="/WEB-INF/views/default/include/header/headerNoMenu.jsp"%>
...
<form:form commandName="registrationTerms" method="post">
  <fieldset>
    ...
    <!-- Display Plans -->
    <div class="registrationTerms"><%@ include file="/WEB-INF/views/default/terms/registration_tos.jsp"%></div>
...
<%@ include file="/WEB-INF/views/default/include/footer/footerNoMenu.jsp"%>