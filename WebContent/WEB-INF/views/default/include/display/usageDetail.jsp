...
<tr>
  ...
  <td>${usageDetail.dateAndTime.month}/${usageDetail.dateAndTime.day}/${usageDetail.dateAndTime.year}${usageDetail.dateAndTime.hour}:<fmt:formatNumber
      value="${usageDetail.dateAndTime.minute}" pattern="00" />
  </td>
  ...
  <td style="text-align: right;"><c:choose>
      ...
      <c:when test="${usageDetail.usageAmount > 0.0 }">
  ...
  <td><img class="info" src="<spring:url value='/static/images/buttons/i.png' />" /> <%@ include
      file="/WEB-INF/views/default/include/display/usageDetailEventBox.jsp"%></td>
