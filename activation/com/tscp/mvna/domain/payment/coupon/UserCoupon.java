...
/**
 * This object represents a coupon that has been applied to a user. Only users that have a coupon applied to the
 * specified account will have a UserCoupon object backing them.
 * 
 */
...
public class UserCoupon implements Serializable {
	...
	public void setKenanContractId(
			int kenanContractId) {
