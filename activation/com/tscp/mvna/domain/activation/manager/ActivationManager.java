package com.tscp.mvna.domain.activation.manager;
...
import com.tscp.mvna.domain.activation.Activation;
import com.tscp.mvna.domain.payment.coupon.Coupon;
import com.tscp.mvna.domain.payment.coupon.CouponRequest;
import com.tscp.mvna.domain.payment.coupon.exception.CouponDoesNotExistException;
...
import com.tscp.mvna.web.flow.util.WebFlowUtil;
...
public class ActivationManager {
	...
	public Account createShellAccount(
			Activation sa) throws AccountManagementException, AddressManagementException {
	...
	public Device addDevice(
			Activation sa) throws DeviceManagementException {
	...
	public void releaseMdn(
			Activation sa) throws DeviceDisconnectException {
	...
	protected void releaseMdn(
			Activation sa, int numRetry, long delay) throws DeviceDisconnectException {
	...
	public NetworkInfo reserveMdn(
			Activation sa) throws DeviceReservationException {
	...
	protected NetworkInfo reserveMdn(
			Activation sa, int numRetry, long delay) throws DeviceReservationException {
	...
	public NetworkInfo activateService(
			Activation sa) throws DeviceActivationException {
	...
	protected NetworkInfo activateService(
			Activation sa, int numRetry, long delay) throws DeviceActivationException {
	...
	public Account createService(
			Activation sa) throws DeviceServiceCreationException {
	...
	protected Account createService(
			Activation sa, int numRetry, long delay) throws DeviceServiceCreationException {
	...
	public NetworkInfo reserveAndActivate(
			Activation sa) throws DeviceReservationException, DeviceActivationException, DeviceDisconnectException, DeviceManagementException {
		try {
			reserveMdn(sa);
	...
	public int applyCoupon(
			Activation sa) throws CouponManagementException {
	...
	public PaymentUnitResponse makeActivationPayment(
			Activation sa) throws PaymentManagementException, PaymentFailureException {
	...
	public void sendServiceErrorNotice(
			Activation sa) throws WebFlowException {
		try {
			SimpleMailMessage myMessage = new SimpleMailMessage();
			myMessage.setTo("wotg_alerts@telscape.net");
			myMessage.setFrom("system-activations@webonthego.com");
